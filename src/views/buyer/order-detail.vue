    ...
    <div class="game-status-detail-wrap">
      <div class="game-status-detail">
            ...
            <div class="game-status-step">
              <el-steps :active="step" align-center>
                ...
                <el-step title="提交订单" icon="el-icon-edit" >
                  <svg-icon name="orders" style="width:2em; height:2em;" slot="icon"/>
                ...
                <el-step title="付款成功" icon="el-icon-edit">
                  <svg-icon name="payment" style="width:2em; height:2em;" slot="icon"/>
                ...
                <el-step title="商品出库" icon="el-icon-edit">
                  <svg-icon name="out_charge" style="width:2em; height:2em;" slot="icon"/>
                ...
                <el-step title="验证商品" icon="el-icon-edit">
                  <svg-icon name="verification" style="width:2em; height:2em;" slot="icon"/>
                ...
                <el-step title="交易完成" icon="el-icon-edit">
                  <svg-icon name="correct" style="width:2em; height:2em;" slot="icon"/>
          ...
          <div class="detail">
            <el-table :data="gameTableData" style="width: 100%">
              ...
              <el-table-column prop="sellstatus" label="状态">
                <template slot-scope="scope">
                  {{ scope.row.sellstatus | getTypeNameByKey(ORDER_STATUS) }}
                </template>
              </el-table-column>
            </el-table>
          </div>
        ...
        <div class="game-status-detail-module">
          ...
          <div class="detail">
            <el-table :data="sellerTableData" style="width: 100%">
              <el-table-column label="卖家" width="200px">
                <template slot-scope="scope">
                  <img :src="scope.row.headerImage" width="100%"/>
                </template>
              </el-table-column>
              <el-table-column prop="sellnickname" label="卖家昵称">
              </el-table-column>
              <el-table-column prop="sellerSteamGrade" label="卖家STEAM等级">
              </el-table-column>
              <el-table-column prop="sellerCdKeyCounts" label="卖家CD-KEY出售次数">
              </el-table-column>
              <el-table-column prop="sellerCreditStatus" label="卖家信用状态">
              </el-table-column>
            </el-table>
          </div>
        </div>
...
export default class extends Vue {
  ...
  private sellerTableData:any = [];   // 卖家信息
  ...
  private async getOrderStatus() {
    ...
    try {
      ...
      console.log(900001, hasJump, jumpPath)
      if (hasJump) {
  ...
  private async getSteamOrderInfo() {
    ...
    try {
      ...
      if (data) {
        ...
        this.sellerTableData.push({
          headerImage: data?.header_image,
          sellnickname: data?.sellnickname,
          sellerSteamGrade: data?.sellerSteamGrade,
          sellerCdKeyCounts: data?.sellerCdKeyCounts,
          sellerCreditStatus: data?.sellerCreditStatus,
        })
      }
      console.log(data)
    } catch (e) {
