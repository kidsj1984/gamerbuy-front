...
server
{
    ...
    server_name www.gamerbuy.cc;
    index index.php index.html index.htm default.php default.htm default.html;
    root /www/wwwroot/www.gamerbuy.cc;

    #SSL-START SSL相关配置，请勿删除或修改下一行带注释的404规则
    #error_page 404/404.html;
    ssl_certificate    /www/server/panel/vhost/cert/www.gamerbuy.cc/fullchain.pem;
    ssl_certificate_key    /www/server/panel/vhost/cert/www.gamerbuy.cc/privkey.pem;
    ...
    include /www/server/panel/vhost/rewrite/www.gamerbuy.cc.conf;
    #REWRITE-END
    ...
    location /v1 {
        proxy_pass https://api.gamerbuy.cc;
        ...
        # proxy_ssl_trusted_certificate /path/to/ssl_certificate.crt;
    }
    
    access_log  /www/wwwlogs/www.gamerbuy.cc.log;
    error_log  /www/wwwlogs/www.gamerbuy.cc.error.log;
}